    ...
    while(another=='y')  //infinite loop
    {
        ...
        if(findbook=='t' )
        {
            ...
            if(getch()=='y')
            {
                ...
                fclose(fp);
                remove("bijoy.dat");
                rename("test.dat","bijoy.dat"); //copy all item from temporary file to fp except that
                fp=fopen("bijoy.dat","rb+");    //we want to delete
                if(findbook=='t')
                {
                    gotoxy(10,10);
...
void searchbooks()
{
    ...
    gotoxy( 15,20);
    printf("Enter Your Choice");
    fp=fopen("bijoy.dat","rb+"); //open file for reading propose
    ...
    case '1':
    {
        ...
        while(fread(&a,sizeof(a),1,fp)==1)
        {
            if(a.id==d)
            {
                ...
                printf("\xB2");
                gotoxy(20,13);
                printf("\xB2 Price:Bdt.%.2f",a.Price);
                gotoxy(47,13);
                printf("\xB2");
                gotoxy(20,14);
